    ...
    function DiffViewer(props) {
        ...
        _this.renderWordDiff = function(diffArray, renderer) {
            return diffArray.map(function(wordDiff, i) {
                ...
                return (React.createElement("span", {
                    key: i,
                    className: classnames_1.default(_this.styles.wordDiff, (_a = {},
        ...
        _this.renderLine = function(lineNumber, type, prefix, value, additionalLineNumber, additionalPrefix) {
            ...
            return (React.createElement(React.Fragment, null, !_this.props.hideLineNumbers && (React.createElement("td", {
                        ...
                        className: classnames_1.default(_this.styles.gutter, (_a = {},
                    ...
                    React.createElement("pre", {
                        ...
                        className: classnames_1.default(_this.styles.gutter, (_b = {},
                ...
                React.createElement("td", {
                        className: classnames_1.default(_this.styles.marker, (_c = {},
                    ...
                    React.createElement("pre", null,
                        ...
                        removed && '-')),
                React.createElement("td", {
                        className: classnames_1.default(_this.styles.content, (_d = {},
            ...
            if (left.type === compute_lines_1.DiffType.REMOVED && right.type === compute_lines_1.DiffType.ADDED) {
                return (React.createElement(React.Fragment, {
                    ...
                    React.createElement("tr", {
                        className: _this.styles.line
                    }, _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, null)),
                    React.createElement("tr", {
                        className: _this.styles.line
        ...
        _this.render = function() {
            ...
            var title = (leftTitle || rightTitle) && (React.createElement("tr", null,
                ...
                splitView && (React.createElement("td", {
            ...
            return (React.createElement("table", {
                    className: classnames_1.default(_this.styles.diffContainer, (_a = {},
